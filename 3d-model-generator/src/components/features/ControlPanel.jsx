  ...
  return (
    <>
      ...
      <div className="instructions">
        <h3>Как использовать выделение области:</h3>
        <ol>
          <li>Нажмите на куб, чтобы выделить область генерации</li>
          <li>Перемещайте камеру с помощью мыши</li>
          <li>Используйте колесо мыши для масштабирования</li>
          <li>Настройте параметры в правой панели</li>
        </ol>
      </div>
    </>
  );
